...
```
cd existing_repo
git remote add origin https://gitlab.com/rafaelcuba81/doce-leguas-website.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rafaelcuba81/doce-leguas-website/-/settings/integrations)
