...
const translations = {
  en: {
    ...
    'home.services.ai.desc': 'Intelligent automation and data-driven decision making.',
  ...
  es: {
    ...
    'home.services.ai.desc': 'Automatización inteligente y toma de decisiones basada en datos.',
